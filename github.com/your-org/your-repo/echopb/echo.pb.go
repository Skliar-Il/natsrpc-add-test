...
// Сообщение запроса для метода Echo.
type EchoRequest struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Текст, который сервер должен вернуть с префиксом.
...
// Сообщение ответа для метода Echo.
type EchoReply struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Ответное сообщение, например: "echo: <message>"
	Message       string `protobuf:"bytes,1,opt,name=message,proto3" json:"message,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
var file_echo_proto_rawDesc = string([]byte{
	...
	0x68, 0x6f, 0x70, 0x62, 0x22, 0x27, 0x0a, 0x0b, 0x45, 0x63, 0x68, 0x6f, 0x52, 0x65, 0x71, 0x75,
	...
	0x09, 0x45, 0x63, 0x68, 0x6f, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x12, 0x18, 0x0a, 0x07, 0x6d, 0x65,
	0x73, 0x73, 0x61, 0x67, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x6d, 0x65, 0x73,
	0x73, 0x61, 0x67, 0x65, 0x32, 0x3f, 0x0a, 0x0b, 0x45, 0x63, 0x68, 0x6f, 0x53, 0x65, 0x72, 0x76,
	0x69, 0x63, 0x65, 0x12, 0x30, 0x0a, 0x04, 0x45, 0x63, 0x68, 0x6f, 0x12, 0x13, 0x2e, 0x65, 0x63,
	0x68, 0x6f, 0x70, 0x62, 0x2e, 0x45, 0x63, 0x68, 0x6f, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74,
	...
	0x72, 0x2d, 0x72, 0x65, 0x70, 0x6f, 0x2f, 0x65, 0x63, 0x68, 0x6f, 0x70, 0x62, 0x3b, 0x65, 0x63,
...
var file_echo_proto_goTypes = []any{
	...
	(*EchoReply)(nil),   // 1: echopb.EchoReply
}
var file_echo_proto_depIdxs = []int32{
	0, // 0: echopb.EchoService.Echo:input_type -> echopb.EchoRequest
	1, // 1: echopb.EchoService.Echo:output_type -> echopb.EchoReply
